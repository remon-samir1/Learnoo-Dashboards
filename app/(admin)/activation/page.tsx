...
export default function ActivationPage() {
  ...
  const currentHistoryStudent = selectedHistoryStudent
    ? (historyStudentsRes?.data || []).find((s: Student) => s.id === selectedHistoryStudent.id) || selectedHistoryStudent
    : null;
  ...
  // Keep deleting/refetching logic same, but use refetchPaginated for DataTable

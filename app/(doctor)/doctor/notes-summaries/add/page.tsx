        ...
        <div className="p-6 space-y-6">
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-3 bg-white border rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#2137D6] focus:ring-opacity-10 transition-all placeholder:text-[#94A3B8] ${errors.title ? 'border-[#EF4444]' : 'border-[#E2E8F0]'
                }`}
            />
            {errors.title && (
          ...
          <div>
            ...
            <select
              ...
              className={`w-full px-4 py-3 bg-white border rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#2137D6] focus:ring-opacity-10 transition-all ${errors.type ? 'border-[#EF4444]' : 'border-[#E2E8F0]'
                }`}
            >
              {NOTE_TYPES.map((t) => (

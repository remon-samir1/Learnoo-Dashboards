  ...
  return (
    <div className="flex flex-col gap-8 pb-12">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <Link
          href="/doctor/notes-summaries/add"
              ...
              {!isLoading && !error && filteredNotes.map((note: Note) => (
                <tr key={note.id} className="hover:bg-[#F8FAFC]/50 transition-colors">
                  ...
                  <td className="px-6 py-4 text-center">
                    <span className={`inline-flex px-3 py-1 rounded-full text-[10px] font-bold tracking-wide ${note.attributes.is_publish

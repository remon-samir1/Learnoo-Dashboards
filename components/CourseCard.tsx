    ...
    <div className="bg-white rounded-2xl border border-[#F1F5F9] overflow-hidden shadow-sm hover:shadow-md transition-all group">
      ...
      >
        ...
        <div className="flex items-center justify-end gap-2 pt-2">
          <button onClick={(e) => { e.stopPropagation(); onView?.(); }} className="p-1.5 text-[#94A3B8] hover:text-[#2137D6] hover:bg-blue-50 rounded-lg transition-colors">
            <Eye className="w-4 h-4" />
          </button>
          <button onClick={(e) => { e.stopPropagation(); onEdit?.(); }} className="p-1.5 text-[#94A3B8] hover:text-[#2137D6] hover:bg-blue-50 rounded-lg transition-colors">
            <Edit2 className="w-4 h-4" />
          </button>
          <button onClick={(e) => { e.stopPropagation(); onDelete?.(); }} className="p-1.5 text-[#94A3B8] hover:text-[#EF4444] hover:bg-red-50 rounded-lg transition-colors">
